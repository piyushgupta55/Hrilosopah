...
export const OnboardingLayout = ({ children, currentStep = 0 }: OnboardingLayoutProps) => {
  ...
  return (
    <div className="flex flex-col w-full h-screen min-h-[100dvh] relative overflow-hidden bg-white text-[#111827]">
      ...
      {/* Main Content Area */}
      <div className="flex-1 w-full max-w-sm mx-auto flex flex-col relative z-0 overflow-y-auto">
        {children}
      </div>
    </div>
  );
