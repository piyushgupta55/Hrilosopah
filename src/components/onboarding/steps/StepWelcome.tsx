      ...
      <div>
        <StepHeader
          title={
            <>
              Welcome to <br />
              <span className="text-[#0052FF]">Hrilosopah</span>
            </>
          }
          ...
          >
            ...
            <div className="relative w-[180px] h-[220px] bg-white border-[3px] border-[#E5E7EB] rounded-[24px] shadow-sm transform -rotate-12 z-10 flex flex-col overflow-hidden">
              ...
              <div className="flex-1 m-2 border-[2px] border-[#F3F4F6] rounded-[16px] bg-gradient-to-b from-[#FAFAFA] to-white flex items-center justify-center">
                <div className="w-16 h-16 bg-[#0052FF] rounded-full flex items-center justify-center shadow-lg">
            ...
            <motion.div
              ...
              className="absolute left-[10%] bottom-[20%] w-14 h-14 bg-white border-[3px] border-[#3B82F6] rounded-full shadow-lg z-20 flex items-center justify-center text-[#3B82F6]"
            >
